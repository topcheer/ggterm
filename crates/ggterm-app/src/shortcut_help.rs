...
fn all_shortcuts() -> Vec<ShortcutEntry> {
    vec![
        ...
        ShortcutEntry {
            ...
            description: "Pin/Unpin tab".into(),
            category: ShortcutCategory::Tab,
            configurable: false,
        },
        // ── Splits ──
        ...
        ShortcutEntry {
            keys: "Alt+Enter".into(),
            description: "Toggle fullscreen (alternate)".into(),
            category: ShortcutCategory::View,
            configurable: false,
        },
        ShortcutEntry {
        ...
        ShortcutEntry {
            keys: "Command Palette".into(),
            description: "Toggle terminal input lock (read-only)".into(),
            category: ShortcutCategory::Terminal,
            configurable: false,
        },
        // ── Shell ──
        ...
        ShortcutEntry {
            ...
            description: "AI: Help with errors".into(),
            category: ShortcutCategory::Ai,
            configurable: false,
        },
        ShortcutEntry {
