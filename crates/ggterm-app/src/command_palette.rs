...
impl CommandRegistry {
    ...
    pub fn defaults() -> Self {
        ...
        r.register(Command {
            id: "terminal.open_in_finder".into(),
            label: "Open Working Directory in File Manager".into(),
            category: "Terminal".into(),
            shortcut: None,
        });
        r.register(Command {
        ...
        r.register(Command {
            id: "terminal.info".into(),
            label: "Show Terminal Info".into(),
            category: "Terminal".into(),
            shortcut: None,
        });
        r.register(Command {
            id: "terminal.jump_first".into(),
            label: "Jump to First Command".into(),
            category: "Terminal".into(),
            shortcut: None,
        });
        r.register(Command {
            id: "terminal.jump_last".into(),
            label: "Jump to Latest Command".into(),
            category: "Terminal".into(),
            shortcut: None,
        });
        r.register(Command {
            id: "terminal.export_commands".into(),
            label: "Export Command History to File".into(),
            category: "Terminal".into(),
            shortcut: None,
        });
        r.register(Command {
        ...
        r.register(Command {
            id: "terminal.clear_and_reset".into(),
            label: "Clear + Reset Terminal (full reset)".into(),
            category: "Terminal".into(),
            shortcut: None,
        });
        r.register(Command {
        ...
        r.register(Command {
            id: "terminal.search_selection".into(),
            label: "Search Selection on the Web".into(),
            category: "Terminal".into(),
            shortcut: None,
        });
        r.register(Command {
            id: "terminal.edit_selection".into(),
            label: "Edit Selection in $EDITOR".into(),
            category: "Terminal".into(),
            shortcut: None,
        });
        r.register(Command {
